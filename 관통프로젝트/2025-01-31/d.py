        ...
        if i == "main" :
            ...
            for x in info[i] :
                ...
                if x == 'feels_like' :
                    ...
                    sort_dict_korea['기본']["체감온도 (섭씨)"] = ((float(info[i][x])-273.15)* 100) // 1 / 100
                if x == 'humidity' :
                ...
                if x == 'temp' :
                    ...
                    sort_dict_korea['기본']["온도 (섭씨)"] = ((float(info[i][x])-273.15)* 100) // 1 / 100
                if x == 'temp_max' :
                    sort_dict_korea['기본']["최고온도"] = info[i][x]
                    sort_dict_korea['기본']["최고온도 (섭씨)"] = ((float(info[i][x])-273.15)* 100) // 1 / 100
                if x == 'temp_min' :
                    sort_dict_korea['기본']["최저온도"] = info[i][x]
                    sort_dict_korea['기본']["최저온도 (섭씨)"] = ((float(info[i][x])-273.15)* 100) // 1 / 100
                if x == 'description' :
